...
void SetupMagic()
{
	...
	// HKEY_CURRENT_USER\Software\Gstarsoft\GstarCAD_2\R19\ko-KR\Profiles\GstarMech2019Pro\Dialogs\Appload\Startup
	keyPath = _T("Software\\Gstarsoft\\GstarCAD_2\\R19\\ko-KR\\Profiles\\GstarMech2019Pro");
	regEdit.SetKey(HKEY_CURRENT_USER, keyPath);
	...
	appList.Add(_T(appPath + "\\MagicCivil.grx"));
	...
	keyPath = _T("Software\\MagicM\\MagicUtil\\MENU");
	regEdit.SetKey(HKEY_CURRENT_USER, keyPath);
	...
	AllowEveryone(_T(appPath + "\\Data"));
	 ...
	 ::MessageBoxA(NULL, _T("Magic 레지스트리 설정이 완료되었습니다."), _T("MAGIC"), MB_OK | MB_ICONINFORMATION);
}

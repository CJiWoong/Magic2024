...
void SetupMagic()
{
	...
	// HKEY_CURRENT_USER\Software\Gstarsoft\GstarCAD\R18\ko-KR\Profiles\<<명명되지 않은 프로파일>>\Dialogs\Appload\Startup
	keyPath = _T("Software\\Gstarsoft\\GstarCAD\\R18\\ko-KR\\Profiles");
	regEdit.SetKey(HKEY_CURRENT_USER, keyPath);

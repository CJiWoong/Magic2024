...
void GetAttrText(double rngSX, double rngSY, double rngEX, double rngEY, double insAng, OdGeScale3d insScl, OdGePoint3d insOrg, CString &attTxt)
{
	GcDbMText* mText;
	GcDbText* text;
	gds_point pt1, pt2;
			...
			*/
			...
			if (previewPlot)
				...
				if (chkPreviw.GetCheck())
					...
					if (chkPLT.GetCheck()) {
						if (m_regEdit.GetString(_T("FNamSet") + nstr, _T("0")) != "0") {

...
BOOL CDlgMPLForm::OnInitDialog()
{
	...
	cbForm1.LoadBitmaps(IDB_ADD, NULL, NULL, NULL);
	cbForm1.SizeToContent();
	cbForm2.LoadBitmaps(IDB_ADD, NULL, NULL, NULL);
	cbForm2.SizeToContent();
	cbForm3.LoadBitmaps(IDB_ADD, NULL, NULL, NULL);
	cbForm3.SizeToContent();
	cbForm4.LoadBitmaps(IDB_ADD, NULL, NULL, NULL);
	cbForm4.SizeToContent();
	cbForm5.LoadBitmaps(IDB_ADD, NULL, NULL, NULL);
	cbForm5.SizeToContent();
	cbForm6.LoadBitmaps(IDB_ADD, NULL, NULL, NULL);
	cbForm6.SizeToContent();
	cbEdt1.LoadBitmaps(IDB_EDT, NULL, NULL, NULL);
	cbEdt1.SizeToContent();
	cbEdt2.LoadBitmaps(IDB_EDT, NULL, NULL, NULL);
	cbEdt2.SizeToContent();
	cbEdt3.LoadBitmaps(IDB_EDT, NULL, NULL, NULL);
	cbEdt3.SizeToContent();
	cbEdt4.LoadBitmaps(IDB_EDT, NULL, NULL, NULL);
	cbEdt4.SizeToContent();
	cbEdt5.LoadBitmaps(IDB_EDT, NULL, NULL, NULL);
	cbEdt5.SizeToContent();
	cbEdt6.LoadBitmaps(IDB_EDT, NULL, NULL, NULL);
	cbEdt6.SizeToContent();
	cbDel1.LoadBitmaps(IDB_DEL, NULL, NULL, NULL);
	cbDel1.SizeToContent();
	cbDel2.LoadBitmaps(IDB_DEL, NULL, NULL, NULL);
	cbDel2.SizeToContent();
	cbDel3.LoadBitmaps(IDB_DEL, NULL, NULL, NULL);
	cbDel3.SizeToContent();
	cbDel4.LoadBitmaps(IDB_DEL, NULL, NULL, NULL);
	cbDel4.SizeToContent();
	cbDel5.LoadBitmaps(IDB_DEL, NULL, NULL, NULL);
	cbDel5.SizeToContent();
	cbDel6.LoadBitmaps(IDB_DEL, NULL, NULL, NULL);
	cbDel6.SizeToContent();

...
// CGcadDocument 래퍼 클래스

class CGcadDocument : public COleDispatchDriver
{
public:
	CGcadDocument(){} // COleDispatchDriver 기본 생성자를 호출합니다.
	CGcadDocument(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CGcadDocument(const CGcadDocument& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
	...
	void InitDoc(unsigned long * pDoc)
	{
		static BYTE parms[] = VTS_PUI4 ;
		InvokeHelper(0x4b, DISPATCH_METHOD, VT_EMPTY, NULL, parms, pDoc);
	}
